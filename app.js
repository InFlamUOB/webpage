...
const TOUR_EXCLUSIVE_DATA = {
  pastShows: [
    // Nov-Dic 2025 — exclusivas no confirmadas (no rastreadas en dtmftracker)
    { slug:"dr1",  flag:"🇩🇴", label:"Sto. Domingo 1", date:"21 Nov", exclusive:null, guest:"Romeo Santos" },
    { slug:"dr2",  flag:"🇩🇴", label:"Sto. Domingo 2", date:"22 Nov", exclusive:null, guest:"Romeo Santos" },
    { slug:"cr1",  flag:"🇨🇷", label:"San José 1",     date:"4 Dic",  exclusive:null, guest:null },
    { slug:"cr2",  flag:"🇨🇷", label:"San José 2",     date:"5 Dic",  exclusive:null, guest:"Jhayco" },
    { slug:"mx1",  flag:"🇲🇽", label:"México N1",      date:"10 Dic", exclusive:null, guest:null },
    { slug:"mx2",  flag:"🇲🇽", label:"México N2",      date:"11 Dic", exclusive:null, guest:"Feid" },
    { slug:"mx3",  flag:"🇲🇽", label:"México N3",      date:"12 Dic", exclusive:null, guest:null },
    { slug:"mx4",  flag:"🇲🇽", label:"México N4",      date:"15 Dic", exclusive:null, guest:"Grupo Frontera" },
    { slug:"mx5",  flag:"🇲🇽", label:"México N5",      date:"16 Dic", exclusive:null, guest:null },
    { slug:"mx6",  flag:"🇲🇽", label:"México N6",      date:"18 Dic", exclusive:null, guest:"Julieta Venegas" },
    { slug:"mx7",  flag:"🇲🇽", label:"México N7",      date:"19 Dic", exclusive:null, guest:null },
    { slug:"mx8",  flag:"🇲🇽", label:"México N8",      date:"21 Dic", exclusive:null, guest:"Natanael Cano + J Balvin" },
    { slug:"cl1",  flag:"🇨🇱", label:"Santiago 1",     date:"9 Ene",  exclusive:null, guest:null },
    { slug:"cl2",  flag:"🇨🇱", label:"Santiago 2",     date:"10 Ene", exclusive:null, guest:"Becky G" },
    { slug:"cl3",  flag:"🇨🇱", label:"Santiago 3",     date:"11 Ene", exclusive:null, guest:"Jowell y Randy" },
    { slug:"pe1",  flag:"🇵🇪", label:"Lima 1",         date:"17 Ene", exclusive:null, guest:null },
    { slug:"pe2",  flag:"🇵🇪", label:"Lima 2",         date:"18 Ene", exclusive:null, guest:null },
    { slug:"co1",  flag:"🇨🇴", label:"Medellín 1",     date:"23 Ene", exclusive:null, guest:"Li Saumet" },
    { slug:"co2",  flag:"🇨🇴", label:"Medellín 2",     date:"24 Ene", exclusive:null, guest:"Arcángel" },
    { slug:"co3",  flag:"🇨🇴", label:"Medellín 3",     date:"25 Ene", exclusive:null, guest:"Karol G" },
    // Feb-Mar 2026 — exclusivas confirmadas (dtmftracker.com)
    { slug:"ar1",  flag:"🇦🇷", label:"Buenos Aires 1", date:"13 Feb", exclusive:null,                  guest:null },
    { slug:"ar2",  flag:"🇦🇷", label:"Buenos Aires 2", date:"14 Feb", exclusive:null,                  guest:null },
